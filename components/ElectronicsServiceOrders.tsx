            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8">
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <label htmlFor="file-upload-electronics" className="w-full flex flex-col items-center justify-center p-4 border-2 border-dashed rounded-md cursor-pointer hover:bg-gray-50">
