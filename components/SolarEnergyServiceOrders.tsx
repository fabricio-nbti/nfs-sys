...
import { MOCK_SOLAR_ENERGY_SERVICE_ORDERS } from '../constants';
            ...
            <h3 className="text-lg font-semibold mb-2 text-primary">Serviço</h3>
             <div className="grid grid-cols-1 gap-4 mb-4">
                ...
                <div className="flex gap-4">
                    ...
                    <input type="number" name="partsCost" step="0.01" placeholder="Custo dos Equipamentos (R$)" value={currentOrder?.partsCost || ''} onChange={handleInputChange} className="p-2 w-full border rounded-md"/>
                </div>
             </div>
