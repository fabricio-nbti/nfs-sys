         ...
         <form onSubmit={handleFormSubmit} className="max-h-[80vh] overflow-y-auto pr-2">
                ...
                <div className="space-y-4">
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="customerNameSolar" className="block text-sm font-medium text-gray-700">Nome do Cliente/Local</label>
                                <input type="text" id="customerNameSolar" name="customerName" value={currentOrder?.customerName || ''} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md" required/>
                            </div>
                             <div>
                                <label htmlFor="customerPhoneSolar" className="block text-sm font-medium text-gray-700">Telefone</label>
                                <input type="tel" id="customerPhoneSolar" name="customerPhone" value={currentOrder?.customerPhone || ''} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md"/>
                            </div>
                            <div className="md:col-span-2">
                                <label htmlFor="customerEmailSolar" className="block text-sm font-medium text-gray-700">E-mail</label>
                                <input type="email" id="customerEmailSolar" name="customerEmail" value={currentOrder?.customerEmail || ''} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label htmlFor="deviceTypeSolar" className="block text-sm font-medium text-gray-700">Tipo de Serviço</label>
                                <select id="deviceTypeSolar" name="deviceType" value={currentOrder?.deviceType || 'Sistema Fotovoltaico On-Grid'} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md bg-white">
                            ...
                            <div>
                                <label htmlFor="deviceBrandSolar" className="block text-sm font-medium text-gray-700">Marca (WEG, Fronius, Canadian...)</label>
                                <input type="text" id="deviceBrandSolar" name="deviceBrand" value={currentOrder?.deviceBrand || ''} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md" required/>
                            </div>
                            <div className="md:col-span-2">
                                <label htmlFor="deviceModelSolar" className="block text-sm font-medium text-gray-700">Modelo (Inversor, Painel...)</label>
                                <input type="text" id="deviceModelSolar" name="deviceModel" value={currentOrder?.deviceModel || ''} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md" required/>
                            </div>
                            <div className="md:col-span-2">
                                <label htmlFor="imeiOrSerialSolar" className="block text-sm font-medium text-gray-700">Endereço da Instalação</label>
                                <input type="text" id="imeiOrSerialSolar" name="imeiOrSerial" value={currentOrder?.imeiOrSerial || ''} onChange={handleInputChange} className="mt-1 p-2 w-full border rounded-md"/>
                            </div>
                            <div className="md:col-span-2">
                                <label htmlFor="accessoriesSolar" className="block text-sm font-medium text-gray-700">Observações</label>
                                <textarea id="accessoriesSolar" name="accessories" placeholder="ex: telhado cerâmico, acesso difícil" value={currentOrder?.accessories || ''} onChange={handleInputChange} rows={2} className="mt-1 p-2 w-full border rounded-md"></textarea>
                            </div>
                        </div>
                    </div>
                     <div>
            ...
            <div className="mt-6 border-t pt-4">
                ...
                <div className="grid grid-cols-1 gap-4 mb-4">
                    ...
                    <div>
                        <label htmlFor="reportedProblemSolar" className="block text-sm font-medium text-gray-700">Serviço Solicitado pelo Cliente</label>
                        <textarea id="reportedProblemSolar" name="reportedProblem" value={currentOrder?.reportedProblem || ''} onChange={handleInputChange} rows={3} className="mt-1 p-2 w-full border rounded-md" required></textarea>
                    </div>
                    <div>
                        <label htmlFor="technicianNotesSolar" className="block text-sm font-medium text-gray-700">Observações Técnicas / Laudo</label>
                        <textarea id="technicianNotesSolar" name="technicianNotes" value={currentOrder?.technicianNotes || ''} onChange={handleInputChange} rows={3} className="mt-1 p-2 w-full border rounded-md"></textarea>
                    </div>
                    <div>
                        <label htmlFor="partsUsedSolar" className="block text-sm font-medium text-gray-700">Equipamentos e Materiais Utilizados</label>
                        <textarea id="partsUsedSolar" name="partsUsed" value={currentOrder?.partsUsed || ''} onChange={handleInputChange} rows={3} className="mt-1 p-2 w-full border rounded-md"></textarea>
                    </div>
